...
@Component
public class ChannelCategoryPredicateBuilder implements IFilterChannelPredicateBuilder {
    ...
    public Predicate build(Root<?> root, CriteriaBuilder criteriaBuilder, FilterChannelDto filterChannelDto) {
        ...
        return criteriaBuilder.equal(root.get("category"), filterChannelDto.getCategory());
    }
}
