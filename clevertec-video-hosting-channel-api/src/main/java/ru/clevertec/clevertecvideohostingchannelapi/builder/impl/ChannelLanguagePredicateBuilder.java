...
@Component
public class ChannelLanguagePredicateBuilder implements IFilterChannelPredicateBuilder {
    ...
    public Predicate build(Root<?> root, CriteriaBuilder criteriaBuilder, FilterChannelDto filterChannelDto) {
        ...
        return criteriaBuilder.equal(root.get("language"), filterChannelDto.getLanguage());
    }
}
